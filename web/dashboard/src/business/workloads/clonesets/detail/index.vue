<template>
  <layout-content :header="$t('commons.form.detail')" :back-to="{name: 'Clonesets'}" v-loading="loading">
    <div v-if="!yamlShow">
      ...
      <el-row :gutter="20" style="margin-top: 20px" class="row-box">
        <el-col :span="12">
          <el-card class="el-card">
            <ko-detail-service :cluster="clusterName" :namespace="namespace" :name="name" resourceType="Cloneset" />
          </el-card>
        </el-col>
        <el-col :span="12">
          <el-card class="el-card">
            <ko-detail-ingress :cluster="clusterName" :namespace="namespace" :name="name" resourceType="Cloneset" />
          </el-card>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20" style="margin-top: 20px" class="row-box">
        <el-col :span="8">
          <el-card class="el-card">
            <ko-detail-pause @refresh="getDetail()" :cluster="clusterName" :yamlInfo="form" resourceType="Cloneset" />
          </el-card>
        </el-col>
        <el-col :span="8">
          <el-card class="el-card">
            <ko-detail-update @refresh="getDetail()" :cluster="clusterName" :yamlInfo="form" resourceType="Cloneset" />
          </el-card>
        </el-col>
        <el-col :span="8">
          <el-card class="el-card">
            <ko-detail-image @refresh="getDetail()" :cluster="clusterName" :yamlInfo="form" resourceType="Cloneset" />
          </el-card>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    getDetail() {
      ...
      this.loading = true
      getWorkLoadByName(this.clusterName, "clonesets", this.namespace, this.name).then((res) => {
        this.form = res
